...
$date=date('YmdHis');
$log->lfile('/tmp/' . $date . '_mylog_postprocess_poprep.log');
 
// write message to the log file
$log->lwrite(' * Starting Postprocess_PopRep.php ...');

# fix breed_id for debugging
$breed_id=6;
$user='';
...
$log->lwrite(" * Rename important tables ...");
