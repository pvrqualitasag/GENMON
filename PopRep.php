...
$log->lwrite(" * Number of animals: " . $i);
...
exec('mv /var/lib/postgresql/projects/'.$project_name.'/Popreport_'.$breed_name.'_*/Inbreeding-'.$breed_name.'.pdf /var/www/html/genmon-ch/pdf');
exec('mv /var/lib/postgresql/projects/'.$project_name.'/Popreport_'.$breed_name.'_*/Population-'.$breed_name.'.pdf /var/www/html/genmon-ch/pdf');
exec('mv /var/lib/postgresql/projects/'.$project_name.'/Popreport_'.$breed_name.'_*/Monitoring-'.$breed_name.'.pdf /var/www/html/genmon-ch/pdf');
$log->lwrite(" * Moving pdf reports ... done");
#exec('rm -R /var/lib/postgresql/projects/'.$project_name);
#$log->lwrite(" * Removing project dir " . $project_name . " ... done");
exec('dropdb -U apiis_admin -w '.$project_name);
